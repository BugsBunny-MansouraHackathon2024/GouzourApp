...
android {
    // TODO: Set Namespace
    namespace = "com.bugsbunny.gouzour"
    compileSdk = 34

    defaultConfig {
        // TODO: Set Package Name
        applicationId = "com.bugsbunny.gouzour"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        val baseUrl = if (apiPropertiesFile.exists()) {
            apiProperties.load(apiPropertiesFile.inputStream())

            apiProperties.getProperty("BASE_URL", "https://dummyjson.com/")
        } else {
            "https://dummyjson.com/"
        }
